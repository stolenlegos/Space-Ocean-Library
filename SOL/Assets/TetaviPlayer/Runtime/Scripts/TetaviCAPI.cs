...
//#if !UNITY_IOS
	...
	[DllImport(m_pluginName)]
	public static extern Int32 stream_get_frame_count(IntPtr native_stream_ptr);
	[DllImport(m_pluginName)]
	public static extern Int32 stream_get_fps(IntPtr native_stream_ptr);
	[DllImport(m_pluginName)]
	public static extern TextureInfo stream_get_video_width_height(IntPtr native_stream_ptr);
	[DllImport(m_pluginName)]
	public static extern Int32 stream_frames_decoded_ahead(IntPtr native_stream_ptr);
	[DllImport(m_pluginName)]
	public static extern Int32 stream_is_buffering(IntPtr native_stream_ptr);
	[DllImport(m_pluginName)]
	public static extern void stream_set_calculate_normals(IntPtr native_stream_ptr, bool calc);
	[DllImport(m_pluginName)]
	public static extern IntPtr stream_get_frame_obj(IntPtr native_stream_ptr, Int32 frame_id);
	[DllImport(m_pluginName)]
	public static extern IntPtr stream_set_progiling_debug_messages(bool state);
	[DllImport(m_pluginName)]
	public static extern Int32 frame_get_id(IntPtr native_frame_ptr);
	[DllImport(m_pluginName)]
	public static extern Int32 frame_get_vertex_count(IntPtr native_frame_ptr);
	[DllImport(m_pluginName)]
	public static extern Int32 frame_get_uv_count(IntPtr native_frame_ptr);
	[DllImport(m_pluginName)]
	...
	[DllImport(m_pluginName)]
	public static extern Int32 frame_is_key(IntPtr native_frame_ptr);
	[DllImport(m_pluginName)]
	...
	[DllImport(m_pluginName)]
	public static extern int audio_player_get_audio_buffer_byte_size(IntPtr native_audio_player_ptr, Int32 frame_idx);
	[DllImport(m_pluginName)]
	public static extern bool audio_player_copy_frame(IntPtr native_audio_player_ptr, Int32 frame_idx, ref IntPtr dest_byte_arr);
